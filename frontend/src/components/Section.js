...
export default function Section() {
  return (
    <React.Fragment>
      <section id="reg_content" class="reg_content">
        ...
        <div class="container text-center">
          ...
          <div class="row reg_auto_height">
            ...
            <div
              class="col-md-6 reg_image_bck reg_wht_txt"
              data-image="http://regal.maskandesign.com/html/images/slider/shutterstock_245330569.jpg"
            >
              <div class="reg_over" data-color="#333" data-opacity="0.8"></div>
              <a
                href="https://www.youtube.com/watch?v=BsekcY04xvQ"
                class="video reg_fullwidth_link"
              ></a>
            ...
            <div class="col-md-6 reg_image_bck" data-color="#f2f2f2">
              <div class="reg_simple_block text-left">
                ...
                <h3>About Regal</h3>
                <p>
                  Our hostel is located in the capital’s hippest and trendiest
                  district: Shoreditch. We are all about East London! Our
                  accommodation is the talk of the town and is ideal for guests
                  who want to be part of the creative and cutting-edge world
                  that is East London. There are literally hundreds of cool
                  bars, quirky boutiques and alternative coffee shops all around
                  us.
                </p>
      ...
      {/* <!-- section --> */}
      <section
        class="reg_section reg_image_bck"
        data-color="#f2f2f2"
        id="rooms"
      >
        <div class="container text-center">
          ...
          <div class="row row_no_pd reg_auto_height">
            ...
            <div class="col-md-6 reg_image_bck" data-color="#fff">
              <div class="reg_simple_block text-left">
                ...
                <ul>
                  <li>
                    18-bed dorm has pod beds with dividing panels, equipped with
                    a bed light and small locker for comfort and privacy
                  </li>
                  <li>
                    8-10 bedded dorm room are mostly used for groups and
                    parties, so everybody can stay together
                  </li>
                  <li>Smaller dorms have normal bunk beds</li>
                  <li>
                    The bigger the room, the cheaper it is! Our 18-bed dorm is
                    the cheapest option for travellers…
                  </li>
                </ul>
                <h3>
                  From <span class="reg_underline_title">$13</span> per bed per
                  night{" "}
                </h3>
              </div>
            </div>
            ...
            <div class="col-md-6 reg_image_bck col-md-pull-6" data-color="#fff">
              <div class="reg_simple_block text-left">
                ...
                <ul>
                  <li>
                    All girls dorms have the same clean and cosy decor and
                    facilities
                  </li>
                  <li>
                    A good value option for girls on a budget, helping you save
                    money and giving you the opportunity to meet fellow
                    travellers, without being surrounded by snoring boys
                  </li>
                  <li>
                    18-bed dorm has pod beds with dividing panels, equipped with
                    a bed light and small locker for comfort and privacy
            ...
            <div class="col-md-6 reg_image_bck" data-color="#fff">
              <div class="reg_simple_block text-left">
                ...
                <h4>
                  Private rooms offer you a bit more intimacy. And a cup of tea
                  or coffee.
                </h4>
                <ul>
                  <li>
                ...
                <br></br>
                <h3>
                  From <span class="reg_underline_title">$20</span> per bed per
                  night{" "}
                </h3>
              </div>
            </div>
      ...
      {/* <!-- section --> */}
      <section
        class="reg_section reg_image_bck reg_fixed reg_wht_txt"
      ...
      <section class="reg_section" id="services">
        <div class="container text-center">
          ...
          <div class="reg_icon_boxes row">
            {/* <!-- animation --> */}
            <div
              data-animation="animation_blocks"
              data-bottom="@class:noactive"
      ...
      >
        <div class="container text-center">
          ...
          <div class="row reg_gallery reg_auto_height reg_wht_txt">
            ...
            <div class="col-md-6">
              <div
                class="reg_gallery_carousel_txt reg_over"
                data-color="#292929"
                data-opacity="0.8"
              >
                <h2>Social Spaces</h2>
          ...
          <div class="reg_icon_boxes row text-center">
            ...
            <div class="reg_team_slider">
              ...
              <div class="reg_icon_box reg_team_box">
                ...
                <h4>
                  <b>William Sanchez</b> <br></br>CEO/Founder
                </h4>
              </div>
              ...
              <div class="reg_icon_box reg_team_box">
                ...
                <h4>
                  <b>Amber Richards</b> <br></br>Managing director
                </h4>
              </div>
              ...
              <div class="reg_icon_box reg_team_box">
                ...
                <h4>
                  <b>Harold Henry</b> <br></br>Computer programmer
                </h4>
              </div>
              ...
              <div class="reg_icon_box reg_team_box">
                ...
                <h4>
                  <b>Austin Burton</b> <br></br>Events organiser
                </h4>
              </div>
              ...
              <div class="reg_icon_box reg_team_box">
                ...
                <h4>
                  <b>Joseph Baker</b> <br></br>Engineer
                </h4>
              </div>
            </div>
            {/* <!-- slider end --> */}
      ...
      <section class="reg_section reg_image_bck" data-color="#f2f2f2" id="map">
        <div class="container text-center">
          ...
          <div class="reg_map">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d38852.53604898047!2d13.352403003182175!3d52.51020916491075!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47a84e373f035901%3A0x042120465b5e3b70!2sBerlin%2C+Germany!5e0!3m2!1sen!2sru!4v1465312283068"
              allowfullscreen
            ></iframe>
          </div>
          {/* <!-- google map end --> */}
        ...
        <div class="container text-center">
          ...
          <div class="row">
            ...
            <div class="col-md-4 reg_special_offers_item">
              <div
                class="reg_special_offers reg_image_bck reg_wht_txt text-left"
                data-color="#292929"
              >
                <div class="reg_special_offers_best">
                  <b>Best Rates</b> Guarantee
                </div>
